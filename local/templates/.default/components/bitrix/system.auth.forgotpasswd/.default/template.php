...
<div class="popup login-popup" id="forgotPopup">
	...
	<div class="popup-content">
		...
		<div class="common-form forgot-form">
			<form name="bform" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>" id="forgotForm">
				...
				<div class="form-footer">
					<input type="submit" name="send_account_info" class="button button-1 button-1-small" value="Отправить" />
				</div>
			</form>
		</div>
