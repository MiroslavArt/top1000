...
<div class="popup login-popup" id="forgotChangePassPopup">
	...
	<div class="popup-content">
		...
		<div class="common-form forgot-change-form">
			...
			<input type="hidden" name="TYPE" value="CHANGE_PWD">
				<div class="form-row">
					<div class="form-item">
						...
						<input type="hidden" name="USER_LOGIN" maxlength="50" value="<?=$arResult["LAST_LOGIN"]?>"  id="login_name"/>
					</div>
				</div>
				<?/*
				<div class="form-row">
				...
				*/?>
					<input type="hidden" name="USER_CHECKWORD" maxlength="50" value="<?=$arResult["USER_CHECKWORD"]?>" required/>
				<div class="form-row">
					<div class="form-item">
