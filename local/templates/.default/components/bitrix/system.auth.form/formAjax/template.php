...
if ($arResult['SHOW_ERRORS'] == 'Y' && $arResult['ERROR']) {
	...
	echo '{"text":"'. htmlspecialcharsEx(str_replace("<br>","",$arResult['ERROR_MESSAGE']['MESSAGE'])).'","error": 1}';
}
?>
	...
	<div class="popup-content">
		...
		<div class="common-form login-form">
			...
			<input type="hidden" name="TYPE" value="AUTH" />
				<div class="form-row">
					<div class="form-item">
						<label for="login_name">Логин1<span class="req">*</span></label>
						<input type="text" name="USER_LOGIN"  id="login_name" required />
					</div>
				</div>
				<div class="form-row">
					<div class="form-item">
						<label for="login_pass">Пароль1<span class="req">*</span></label>
						<input type="password" name="USER_PASSWORD" id="login_pass" required />
					</div>
				</div>
				<div class="form-footer">
					<button type="submit" name="Login" class="button button-1 button-1-small">Войти</button>
				</div>
				<div class="forgot-link-wrapper">
					<a href="#" class="forgot-link">Я забыл свой пароль</a>
				</div>
			</form>
		</div>
