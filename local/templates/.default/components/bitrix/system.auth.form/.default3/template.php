...
?>
						<div class="enter-wrapper">
							<a href="#" class="enter-button realtors-login-trigger">
								Войти в личный&nbsp;кабинет
							</a>
							<div class="common-form realtors-login-form">
								<form name="system_auth_form<?=$arResult["RND"]?>" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
									<input type="hidden" name="AUTH_FORM" value="Y" />
									<input type="hidden" name="TYPE" value="AUTH" />
									<div class="form-row">
										<div class="form-item">
											<label for="login_name" class="placeholder">Логин</label>
											<input type="text" name="USER_LOGIN" id="login_name"  value="<?=$arResult["USER_LOGIN"]?>" required />
										</div>
									</div>
									<div class="form-row">
										<div class="form-item">
											<label for="login_password" class="placeholder">Пароль</label>
											<input type="password" name="USER_PASSWORD" id="login_password" required />
										</div>
									</div>
									<?/*
									...
									*/?>
									<div class="form-footer">
										...
										<input type="submit" name="Login" value="<?=GetMessage("AUTH_LOGIN_BUTTON")?>" class="button button-3" value="Войти" />
									</div>
								</form>
							</div>
						</div>
