						...
						<?ShowError($arResult["strProfileError"]);?>
							...
							<div class="form-row clearfix">
								<div class="form-item clearfix">
									...
									<div class="input-wrapper input-wrapper-narrow">
										<select name="profile_branch" id="profile_branch" value="1" >
											<option value="">Выберите отрасль</option>
											<option value="1">Металлургия</option>
											<option value="2">Добыча нефти и газа</option>
											<option value="3">Финансы</option>
											<option value="4">Длинное название, которое не поместится</option>
										</select>
									</div>
								</div>
							</div>
							<div class="form-row clearfix">
								<div class="form-item clearfix">
									...
									<div class="input-wrapper">
										<select name="profile_direction" id="profile_direction" value="3"  >
											<option value="">Выберите функциональное направление</option>
											<option value="1">Металлургия</option>
											<option value="2">Добыча нефти и газа</option>
											<option value="3">Финансы</option>
											<option value="4">Длинное название, которое не поместится</option>
											<option value="5">Металлургия</option>
											<option value="6">Добыча нефти и газа</option>
											<option value="7">Финансы</option>
											<option value="8">Длинное название, которое не поместится</option>
											<option value="9">Металлургия</option>
											<option value="10">Добыча нефти и газа</option>
											<option value="11">Финансы</option>
											<option value="12">Длинное название, которое не поместится</option>
										</select>
									</div>
								</div>
							</div>
							<div class="form-row clearfix">
								<div class="form-item clearfix">
									...
									<div class="input-wrapper">
										<input type="text" name="profile_post" id="profile_post" value="Директор по маркетингу" required />
									</div>
								</div>
							</div>
							<div class="form-row clearfix">
							...
							<div class="form-row clearfix">
								<div class="form-item clearfix">
									...
									<div class="input-wrapper input-wrapper-narrow">
										<input type="text" name="profile_lastcompany" id="profile_lastcompany" value="Adidas" />
									</div>
								</div>
							</div>
							<div class="form-row clearfix">
								<div class="form-item clearfix">
									...
									<div class="input-wrapper">
										<textarea name="profile_achievements" id="profile_achievements" rows="6" >В качестве основных объектов для рейтингования рассматриваются первые лица и руководители функциональных подразделений компаний. Основной принцип оценки кандидатов рейтинга — «лучшие выбирают лучших»: топ-менеджеры оценивают топ-менеджеров, функциональные управленцы оценивают функциональных управленцев. Подобный принцип позволяет получить максимально объективную оценку профессиональной репутации кандидата.</textarea>
									</div>
								</div>
							</div>
							<div class="form-row clearfix">
								<div class="form-item clearfix">
									...
									<div class="input-wrapper input-wrapper-narrow">
										<input type="text" name="profile_phone" id="profile_phone" class="phone" value="+7 (911) 222-33-44" required />
									</div>
								</div>
							</div>
							<div class="form-footer">
								<button type="submit" name="save" class="button button-1 button-1-small">Сохранить</button>
							</div>
						</form>
					</div>
